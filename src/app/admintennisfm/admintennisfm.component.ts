...
@Component({
  selector: 'app-admintennisfm',
  templateUrl: './admintennisfm.component.html',
  styleUrls: ['./admintennisfm.component.css']
})
export class AdmintennisfmComponent implements OnInit {
